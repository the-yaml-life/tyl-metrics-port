...
pub fn metrics_config_error(config_key: impl Into<String>, message: impl Into<String>) -> TylError {
    TylError::configuration(format!("Metrics config error for {}: {}", config_key.into(), message.into()))
}
...
/// ```
pub fn metrics_connection_error(endpoint: impl Into<String>, message: impl Into<String>) -> TylError {
    TylError::network(format!("Metrics connection error to {}: {}", endpoint.into(), message.into()))
}
...
/// ```
pub fn metrics_recording_error(metric_name: impl Into<String>, message: impl Into<String>) -> TylError {
    TylError::internal(format!("Metrics recording error for {}: {}", metric_name.into(), message.into()))
}
...
/// ```
pub fn metrics_adapter_error(adapter_type: impl Into<String>, message: impl Into<String>) -> TylError {
    TylError::internal(format!("Metrics adapter error for {}: {}", adapter_type.into(), message.into()))
}
...
/// ```
pub fn metrics_health_error(adapter_type: impl Into<String>, message: impl Into<String>) -> TylError {
    TylError::internal(format!("Metrics health check error for {}: {}", adapter_type.into(), message.into()))
}
...
/// ```
pub fn metrics_serialization_error(format: impl Into<String>, message: impl Into<String>) -> TylError {
    TylError::internal(format!("Metrics serialization error for {}: {}", format.into(), message.into()))
}
...
pub fn metrics_timeout_error(operation: impl Into<String>, timeout_secs: u64) -> TylError {
    TylError::internal(format!("Metrics timeout error for {} after {}s", operation.into(), timeout_secs))
}
...
pub fn from_io_error(error: std::io::Error) -> TylError {
    match error.kind() {
        ...
        std::io::ErrorKind::TimedOut => {
            metrics_timeout_error("io_operation", 0)
        }
        _ => {
            TylError::internal(format!("Metrics IO error: {}", error))
        }
    }
}
